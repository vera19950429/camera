...
import com.example.myapp.filter.AFilter;
import com.example.myapp.filter.CameraFilter;
import com.example.myapp.utils.EasyGlUtils;
 ...
 * Description:
 */
public class TextureFilter extends AFilter {//在CameraFilter的基础上增加了SUrfaceTexture相关功能
    ...
    public void draw() {
        ...
        mFilter.draw();
        Log.v("wuwang","textureFilter draw");
